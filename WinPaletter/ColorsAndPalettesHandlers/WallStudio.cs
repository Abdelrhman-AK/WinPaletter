...
namespace WinPaletter
{
    public partial class WallStudio : UI.WP.Form
    {
        private static class ReflectionCache
        {
            ...
            public static readonly PropertyInfo[] Win32UIProps = [.. typeof(Theme.Structures.Win32UI).GetProperties(BindingFlags.Public | BindingFlags.Instance).Where(p => p.PropertyType == typeof(Color) && p.CanRead && p.CanWrite)];

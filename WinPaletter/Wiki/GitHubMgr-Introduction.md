...
- Managing **your personal theme repositories**
...
> [!important]
> The previous multi-step publishing process described in the old Store Developers guide is now **deprecated**.
...
No external Git client required.
No advanced Git knowledge required.
...
- A GitHub account
- Internet connection
- Using WinPaletter application itself (not GitHub within the browser)

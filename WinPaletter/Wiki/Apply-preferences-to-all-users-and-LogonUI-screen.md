...
![User Preference Mask](Assets/Settings/UPM.png?raw=true)
...
![Copy Wallpaper](Assets/Settings/CopyWallpaper.png?raw=true)
...
![Copy Classic Colors](Assets/Settings/CopyClassicColors.png?raw=true)
...
![Copy Metrics & Fonts](Assets/Settings/CopyMetricsFonts.png?raw=true)
...
![Copy Cursors](Assets/Settings/CopyCursors.png?raw=true)
...
![Override Command Prompt](Assets/Settings/OverrideCommandPrompt.png?raw=true)

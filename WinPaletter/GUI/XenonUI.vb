...
#Region "Events"
    ...
    Private Sub XenonRadioButton_HandleDestroyed(sender As Object, e As EventArgs) Handles Me.HandleDestroyed
        Try
            If Not DesignMode Then
                RemoveHandler FindForm.Shown, AddressOf Showed
                RemoveHandler Parent.BackColorChanged, AddressOf RefreshColorPalette
...
<DefaultEvent("Click")>
Public Class XenonCP : Inherits Panel
    ...
    Protected Overrides Sub OnDragDrop(e As DragEventArgs)
        If AllowDrop AndAlso My.Settings.NerdStats.DragAndDrop Then
            ...
            Else
                ...
                Dim Color_From As Color = CType(e.Data.GetData("WinPaletter.XenonCP"), XenonCP).BackColor
                ...
                CType(e.Data.GetData("WinPaletter.XenonCP"), XenonCP).BackColor = Color_To
    ...
    Private Sub XenonComboBox_HandleDestroyed(sender As Object, e As EventArgs) Handles Me.HandleDestroyed
        Try
            If Not DesignMode Then
                ...
                RemoveHandler BackColorChanged, AddressOf Invalidate
            End If
        Catch
        End Try
    End Sub
...
#End Region
    ...
    End Sub
End Class
Public Class XenonAlertBox : Inherits ContainerControl
...
Public Class XenonItemSelection : Inherits ContainerControl
    Sub New()
        DoubleBuffered = True
        SetStyle(ControlStyles.SupportsTransparentBackColor, True)
        BackColor = Color.Transparent
...
#End Region
    ...
    Protected Overrides Sub OnPaint(e As PaintEventArgs)
        ...
        If Not String.IsNullOrWhiteSpace(Text) AndAlso Text.Trim = Text_English.Trim Then
            G.FillRectangle(New SolidBrush(NotTranslatedColor), rect)
        End If

        If Tag IsNot Nothing AndAlso Not String.IsNullOrWhiteSpace(Tag.ToString) AndAlso Tag.ToString.Trim = Tag_English.Trim Then
            G.FillRectangle(New SolidBrush(NotTranslatedColor), rect)
        End If

        If Pressed Then
            G.FillRectangle(New SolidBrush(Style.Colors.Back_Checked), rect)
            G.DrawRectangle(New Pen(If(GetDarkMode(), Color.White, Color.Black), 2) With {.DashStyle = DashStyle.Dot}, rect)
        Else
            G.DrawRectangle(New Pen(Color.FromArgb(100, If(GetDarkMode(), Color.White, Color.Black)), 1), rect)
        End If

...
Namespace UI.Controllers
    ...
    <ToolboxItem(False)> <DefaultEvent("Click")> Public Class StoreItem : Inherits Panel
...
#End Region
        ...
        Protected Overrides Sub OnPaint(e As PaintEventArgs)
            ...
            Dim bkC As Color = Color.FromArgb(255 - alpha, My.Style.Colors.Back)
            ...
            Dim lC As Color = Color.FromArgb(255 - alpha, If(State <> MouseState.None, My.Style.Colors.Border_Checked, My.Style.Colors.Border))
            ...
            If CP IsNot Nothing Then
                ...
                G.DrawString(CP.Info.ThemeName, New Font(CP.MetricsFonts.CaptionFont.Name, 11, FontStyle.Bold), New SolidBrush(FC), ThemeName_Rect, ContentAlignment.MiddleRight.ToStringFormat)
                ...
                G.DrawString(My.Lang.By & " " & author, New Font(CP.MetricsFonts.CaptionFont.Name, 9, FontStyle.Regular), New SolidBrush(FC), Author_Rect, ContentAlignment.MiddleRight.ToStringFormat)

                G.DrawImage(My.Resources.Store_ThemeVersion, VerRect)
                G.DrawString(CP.Info.ThemeVersion, My.Application.ConsoleFont, New SolidBrush(FC), Version_Rect, ContentAlignment.MiddleRight.ToStringFormat)

...
Namespace UI.WP
    ...
    <Description("Themed Trackbar for selecting colors (HSL) for WinPaletter UI")> <DefaultEvent("Scroll")> Public Class ColorBar : Inherits Control
...
#Region "Events"
        ...
        Private Sub ColorBar_MouseUp(sender As Object, e As MouseEventArgs) Handles Me.MouseUp
            ThumbDown = False
        ...
        Private Sub ColorBar_MouseEnter(sender As Object, e As EventArgs) Handles Me.MouseEnter
        ...
        Private Sub ColorBar_MouseLeave(sender As Object, e As EventArgs) Handles Me.MouseLeave
            State = MouseState.None
            Timer.Enabled = True
            Timer.Start()
            Invalidate()
        ...
        Private Sub ColorBar_MouseWheel(sender As Object, e As MouseEventArgs) Handles Me.MouseWheel
            If e.Delta < 0 Then
        ...
        Private Sub ColorBar_HandleCreated(sender As Object, e As EventArgs) Handles Me.HandleCreated
            Try
        ...
        Private Sub ColorBar_HandleDestroyed(sender As Object, e As EventArgs) Handles Me.HandleDestroyed
            Try
                If Not DesignMode Then

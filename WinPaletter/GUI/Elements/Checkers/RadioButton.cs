...
namespace WinPaletter.UI.WP
{
    ...
    public class RadioButton : Control
    {
        ...
        public bool Checked
        {
            ...
            set
            {
                if (_Checked != value)
                {
                    ...
                    if (CanAnimate)
                    {
                        Transition.With(this, nameof(alpha2), Checked ? 255 : 0).CriticalDamp(Program.AnimationSpan);
                    }
        ...
        protected override void OnMouseClick(MouseEventArgs e)
        {
            ...
            if (CanAnimate) { Transition.With(this, nameof(alpha2), Checked ? 255 : 0).CriticalDamp(Program.AnimationSpan); }
            else { alpha2 = Checked ? 255 : 0; }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (LinearGradientBrush lgb1 = new(OuterCircle_GradienceFix, Color.FromArgb(Math.Max(255 - alpha, 0), scheme.Colors.Line_Hover(parentLevel - 10)), Color.FromArgb(Math.Max(255 - alpha, 0), scheme.Colors.Line(parentLevel + 20)), LinearGradientMode.Vertical))

...
Public Class Start8Selector
    ...
    Sub LoadImagesFromDLL()
        img1.Image = My.Application.WinRes.MetroStart_1.Resize(64, 64)
        img2.Image = My.Application.WinRes.MetroStart_2.Resize(64, 64)
        img3.Image = My.Application.WinRes.MetroStart_3.Resize(64, 64)
        img4.Image = My.Application.WinRes.MetroStart_4.Resize(64, 64)
        img5.Image = My.Application.WinRes.MetroStart_5.Resize(64, 64)
        img6.Image = My.Application.WinRes.MetroStart_6.Resize(64, 64)
        img7.Image = My.Application.WinRes.MetroStart_7.Resize(64, 64)
        img8.Image = My.Application.WinRes.MetroStart_8.Resize(64, 64)
        img9.Image = My.Application.WinRes.MetroStart_9.Resize(64, 64)
        img10.Image = My.Application.WinRes.MetroStart_10.Resize(64, 64)
        img11.Image = My.Application.WinRes.MetroStart_11.Resize(64, 64)
        img12.Image = My.Application.WinRes.MetroStart_12.Resize(64, 64)
        img13.Image = My.Application.WinRes.MetroStart_13.Resize(64, 64)
        img14.Image = My.Application.WinRes.MetroStart_14.Resize(64, 64)
        img15.Image = My.Application.WinRes.MetroStart_15.Resize(64, 64)
        img16.Image = My.Application.WinRes.MetroStart_16.Resize(64, 64)
        img17.Image = My.Application.WinRes.MetroStart_17.Resize(64, 64)
        img18.Image = My.Application.WinRes.MetroStart_18.Resize(64, 64)
        img19.Image = MainFrm.CP.Windows8.PersonalColors_Background.ToBitmap(New Size(64, 64))
        img20.Image = My.Application.GetCurrentWallpaper.Resize(64, 64)
    End Sub

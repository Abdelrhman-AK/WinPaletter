...
Public Class Converter_Form
    ...
    Private Sub Converter_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadLanguage
        ApplyStyle(Me)
        CheckBox1.Checked = My.Settings.FileTypeManagement.CompressThemeFile
        Label3.Font = My.Application.ConsoleFontMedium

        If IO.File.Exists(MainFrm.OpenFileDialog1.FileName) AndAlso Not IO.File.Exists(TextBox1.Text) Then
            TextBox1.Text = MainFrm.OpenFileDialog1.FileName
        End If
    ...
    Private Sub TextBox1_TextChanged(sender As Object, e As EventArgs) Handles TextBox1.TextChanged
        Select Case _Convert.FetchFile(TextBox1.Text)
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        If Not _Convert.FetchFile(TextBox1.Text) = Converter_CP.WP_Format.Error Then

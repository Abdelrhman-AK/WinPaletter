Public Class WinResources
    ...
    Sub New()
        If My.W8 Then
            MetroStart_1 = NativeMethods.DLLFunc.GetDllRes(My.PATH_imageres, 22001, "PNG")
            MetroStart_2 = NativeMethods.DLLFunc.GetDllRes(My.PATH_imageres, 21601, "PNG")
            MetroStart_3 = NativeMethods.DLLFunc.GetDllRes(My.PATH_imageres, 22101, "PNG")
            MetroStart_4 = NativeMethods.DLLFunc.GetDllRes(My.PATH_imageres, 21901, "PNG")
            MetroStart_5 = NativeMethods.DLLFunc.GetDllRes(My.PATH_imageres, 21501, "PNG")
            MetroStart_6 = NativeMethods.DLLFunc.GetDllRes(My.PATH_imageres, 21701, "PNG")
            MetroStart_7 = NativeMethods.DLLFunc.GetDllRes(My.PATH_imageres, 21301, "PNG")
            MetroStart_8 = NativeMethods.DLLFunc.GetDllRes(My.PATH_imageres, 20701, "PNG")
            MetroStart_9 = NativeMethods.DLLFunc.GetDllRes(My.PATH_imageres, 21201, "PNG")
            MetroStart_10 = NativeMethods.DLLFunc.GetDllRes(My.PATH_imageres, 20501, "PNG")
            MetroStart_11 = NativeMethods.DLLFunc.GetDllRes(My.PATH_imageres, 21001, "PNG")
            MetroStart_12 = NativeMethods.DLLFunc.GetDllRes(My.PATH_imageres, 20801, "PNG")
            MetroStart_13 = NativeMethods.DLLFunc.GetDllRes(My.PATH_imageres, 20601, "PNG")
            MetroStart_14 = NativeMethods.DLLFunc.GetDllRes(My.PATH_imageres, 20401, "PNG")
            MetroStart_15 = NativeMethods.DLLFunc.GetDllRes(My.PATH_imageres, 21401, "PNG")
            MetroStart_16 = NativeMethods.DLLFunc.GetDllRes(My.PATH_imageres, 21101, "PNG")
            MetroStart_17 = NativeMethods.DLLFunc.GetDllRes(My.PATH_imageres, 20301, "PNG")
            MetroStart_18 = NativeMethods.DLLFunc.GetDllRes(My.PATH_imageres, 20201, "PNG")
            MetroLock_0 = NativeMethods.DLLFunc.GetDllRes(My.PATH_Windows_UI_Immersive_dll, 39169)
            MetroLock_1 = NativeMethods.DLLFunc.GetDllRes(My.PATH_Windows_UI_Immersive_dll, 39172)
            MetroLock_2 = NativeMethods.DLLFunc.GetDllRes(My.PATH_Windows_UI_Immersive_dll, 39175)
            MetroLock_3 = NativeMethods.DLLFunc.GetDllRes(My.PATH_Windows_UI_Immersive_dll, 39178)
            MetroLock_4 = NativeMethods.DLLFunc.GetDllRes(My.PATH_Windows_UI_Immersive_dll, 39181)
            MetroLock_5 = NativeMethods.DLLFunc.GetDllRes(My.PATH_Windows_UI_Immersive_dll, 39184)
        Else

...
Public Class WinResources
    ...
    Sub New()
        ...
        Else
            ...
            MetroStart_1 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroStart_2 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroStart_3 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroStart_4 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroStart_5 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroStart_6 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroStart_7 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroStart_8 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroStart_9 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroStart_10 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroStart_11 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroStart_12 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroStart_13 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroStart_14 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroStart_15 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroStart_16 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroStart_17 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroStart_18 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroLock_0 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroLock_1 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroLock_2 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroLock_3 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroLock_4 = ColorToBitmap(Color.Black, New Size(50, 50))
            MetroLock_5 = ColorToBitmap(Color.Black, New Size(50, 50))
        End If
    End Sub
End Class

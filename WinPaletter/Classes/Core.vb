...
Public Class Core
    Public Shared Sub RefreshDWM(CP As CP)
        ...
        End Try
    End Sub
    Public Shared Sub RestartExplorer(Optional [TreeView] As Windows.Forms.TreeView = Nothing)
        With My.Application
...
Public Module FormDWMEffects
    ...
    Sub DrawMica(Form As Form, Margins As Padding, Optional Style As MicaStyle = MicaStyle.Mica)
        ...
        DLLFunc.DarkTitlebar(Form.Handle, My.Style.DarkMode)
...
Public Class RGBColorComparer : Implements IComparer(Of Color)

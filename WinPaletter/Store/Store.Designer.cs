...
namespace WinPaletter
{
    ...
    public partial class Store : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Arrow = new WinPaletter.CursorControl();
            this.Help = new WinPaletter.CursorControl();
            this.AppLoading = new WinPaletter.CursorControl();
            this.Busy = new WinPaletter.CursorControl();
            this.Move_Cur = new WinPaletter.CursorControl();
            this.Up = new WinPaletter.CursorControl();
            this.NS = new WinPaletter.CursorControl();
            this.EW = new WinPaletter.CursorControl();
            this.NESW = new WinPaletter.CursorControl();
            this.NWSE = new WinPaletter.CursorControl();
            this.Pen = new WinPaletter.CursorControl();
            this.None = new WinPaletter.CursorControl();
            this.Link = new WinPaletter.CursorControl();
            this.Pin = new WinPaletter.CursorControl();
            this.Person = new WinPaletter.CursorControl();
            this.IBeam = new WinPaletter.CursorControl();
            this.Cross = new WinPaletter.CursorControl();

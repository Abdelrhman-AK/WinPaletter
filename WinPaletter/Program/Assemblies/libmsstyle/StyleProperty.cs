...
namespace libmsstyle
{
    public class PropertyHeader : ICloneable
    {
        ...
        public override bool Equals(object o)
        {
            ...
            PropertyHeader other = (PropertyHeader)o;
    ...
    public class StyleProperty
    {
        ...
        public string GetValueAsString()
        {
            switch ((IDENTIFIER)Header.typeID)
            {
                case IDENTIFIER.INTLIST:
                    {
                        List<int> l = (List<Int32>)GetValue();
                ...
                case IDENTIFIER.HIGHCONTRASTCOLORTYPE:
                    {
                        ...
                        List<VisualStyleEnumEntry> list = VisualStyleEnums.Find(Header.nameID);
                        if (list == null)
                        {
                            return "UNKNOWN ENUM";
                        }
                ...
                case IDENTIFIER.POSITION:
                    {
                        Size p = (Size)GetValue();
                        return $"{p.Width}, {p.Height}";
                    }
                case IDENTIFIER.RECTTYPE:
                case IDENTIFIER.MARGINS:
                    {
                        Margins m = (Margins)GetValue();

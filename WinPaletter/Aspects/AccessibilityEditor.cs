...
namespace WinPaletter
{
    public partial class AccessibilityEditor
    {
        ...
        private void LoadFromCurrent(object sender, EventArgs e)
        {
            ...
            {
                TMx.Accessibility.Load(Default.FromOS(Program.WindowStyle).Accessibility);
                LoadFromTM(TMx);
            }
        }
        ...
        private void LoadFromDefault(object sender, EventArgs e)
        {
            using (Manager TMx = Program.TM.Clone())
            {
                TMx.Accessibility = Default.FromOS(Program.WindowStyle).Accessibility;
                LoadFromTM(TMx);
            }
        }
        ...
        private void Apply(object sender, EventArgs e)
        {
            ...
            Program.TM.Accessibility.Apply();
        ...
        private void HighContrastEditor_Load(object sender, EventArgs e)
        {
            ...
            {
                AspectName = Program.Localization.Strings.Aspects.Accessibility,

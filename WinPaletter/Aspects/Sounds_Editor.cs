...
namespace WinPaletter
{
    public partial class Sounds_Editor
    {
        ...
        private void LoadFromCurrent(object sender, EventArgs e)
        {
            ...
            {
                TMx.Sounds.Load(Default.FromOS(Program.WindowStyle).Sounds);
                LoadFromTM(TMx);
            }
        }
        ...
        private void LoadFromDefault(object sender, EventArgs e)
        {
            using (Manager TMx = Program.TM.Clone())
            {
                TMx.Sounds = Default.FromOS(Program.WindowStyle).Sounds;
                LoadFromTM(TMx);
            }
        }
        ...
        {
            using (OpenFileDialog dlg = new() { Filter = Program.Filters.WAV, Title = Program.Localization.Strings.Extensions.OpenWAV })
            {
        ...
        private void Sounds_Editor_Load(object sender, EventArgs e)
        {
            ...
            {
                AspectName = Program.Localization.Strings.Aspects.Sounds,

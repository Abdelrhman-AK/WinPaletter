...
namespace WinPaletter
{
    public partial class Win12Colors : AspectsTemplate
    {
        ...
        private void LoadFromCurrent(object sender, EventArgs e)
        {
            ...
            {
                TMx.Windows12.Load(Default.FromOS(Program.WindowStyle).Windows12);
                LoadFromTM(TMx);
            }
        }
        ...
        private void LoadFromDefault(object sender, EventArgs e)
        {
            using (Manager TMx = Program.TM.Clone())
            {
                TMx.Windows12 = Default.FromOS(Program.WindowStyle).Windows12;
                LoadFromTM(TMx);
            }
        }
        ...
        private void Win10Colors_Load(object sender, EventArgs e)
        {
            ...
            {
                AspectName = string.Format(Program.Localization.Strings.Aspects.WinTheme, Program.Localization.Strings.Windows.W12),
        ...
        public void ApplyToTM(Manager TM)
        {
            ...
            TM.Windows12.VisualStyles.ColorScheme = (VS_ColorsList.SelectedItem ?? string.Empty).ToString();
            TM.Windows12.VisualStyles.SizeScheme = (VS_SizesList.SelectedItem ?? string.Empty).ToString().ToLower() == "normal" ? "NormalSize" : (VS_SizesList.SelectedItem ?? string.Empty).ToString();
        ...
        private void VS_textbox_TextChanged(object sender, EventArgs e)
        {
            ...
            if (File.Exists(VS_textbox.Text))
            {

...
namespace WinPaletter
{
    public partial class Win81Colors : AspectsTemplate
    {
        ...
        private void LoadFromCurrent(object sender, EventArgs e)
        {
            ...
            {
                TMx.Windows81.Load(Default.FromOS(Program.WindowStyle).Windows81);
                LoadFromTM(TMx);
            }
        }
        ...
        private void LoadFromDefault(object sender, EventArgs e)
        {
            using (Manager TMx = Program.TM.Clone())
            {
                TMx.Windows81 = Default.FromOS(Program.WindowStyle).Windows81;
                LoadFromTM(TMx);
            }
        }
        ...
        private void Apply(object sender, EventArgs e)
        {
            ...
            ApplyToTM(Program.TM);
            Program.TM.Windows81.Apply(Program.TM);
        ...
        private void Win7Colors_Load(object sender, EventArgs e)
        {
            ...
            img20.Image = windowsDesktop1.BackgroundImage.Resize(40, 40);

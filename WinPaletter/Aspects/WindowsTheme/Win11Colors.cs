...
namespace WinPaletter
{
    public partial class Win11Colors : AspectsTemplate
    {
        ...
        private void LoadFromCurrent(object sender, EventArgs e)
        {
            ...
            {
                TMx.Windows11.Load(Default.FromOS(Program.WindowStyle).Windows11);
                LoadFromTM(TMx);
            }
        }
        ...
        private void LoadFromDefault(object sender, EventArgs e)
        {
            using (Manager TMx = Program.TM.Clone())
            {
                TMx.Windows11 = Default.FromOS(Program.WindowStyle).Windows11;
                LoadFromTM(TMx);
            }
        }
        ...
        public void ApplyToTM(Manager TM)
        {
            ...
            TM.Windows11.VisualStyles.ColorScheme = (VS_ColorsList.SelectedItem ?? string.Empty).ToString();
            TM.Windows11.VisualStyles.SizeScheme = (VS_SizesList.SelectedItem ?? string.Empty).ToString().ToLower() == "normal" ? "NormalSize" : (VS_SizesList.SelectedItem ?? string.Empty).ToString();

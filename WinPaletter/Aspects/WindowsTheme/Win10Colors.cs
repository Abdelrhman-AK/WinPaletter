...
namespace WinPaletter
{
    public partial class Win10Colors : AspectsTemplate
    {
        ...
        private void Win10Colors_Load(object sender, EventArgs e)
        {
            ...
            {
                AspectName = string.Format(Program.Localization.Strings.Aspects.WinTheme, Program.Localization.Strings.Windows.W10),
            ...
            ToolStripMenuItem item0 = new(string.Format(Program.Localization.Strings.General.CopycatFrom, Program.Localization.Strings.Windows.W11));

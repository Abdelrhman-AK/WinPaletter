...
namespace WinPaletter
{
    public partial class Win8Colors : AspectsTemplate
    {
        ...
        private void LoadFromCurrent(object sender, EventArgs e)
        {
            ...
            {
                TMx.Windows8.Load(Default.FromOS(Program.WindowStyle).Windows8);
                LoadFromTM(TMx);
            }
        }
        ...
        private void LoadFromDefault(object sender, EventArgs e)
        {
            using (Manager TMx = Program.TM.Clone())
            {
                TMx.Windows8 = Default.FromOS(Program.WindowStyle).Windows8;
                LoadFromTM(TMx);
            }
        }
        ...
        private void Apply(object sender, EventArgs e)
        {
            ...
            ApplyToTM(Program.TM);
            Program.TM.Windows8.Apply(Program.TM);
        ...
        public void ApplyToTM(Manager TM)
        {
            ...
            TM.Windows8.ColorizationColorBalance = (int)ColorizationColorBalance_bar.Value;
            ...
            TM.Windows8.VisualStyles.ColorScheme = (VS_ColorsList.SelectedItem ?? string.Empty).ToString();
            TM.Windows8.VisualStyles.SizeScheme = (VS_SizesList.SelectedItem ?? string.Empty).ToString().ToLower() == "normal" ? "NormalSize" : (VS_SizesList.SelectedItem ?? string.Empty).ToString();

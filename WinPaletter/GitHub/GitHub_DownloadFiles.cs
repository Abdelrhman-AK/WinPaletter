...
{
    public partial class GitHub_DownloadFiles : Form
    {
        ...
        public async void DownloadFilesAsync(string GitHubPath, string DestinationPath)
        {
            cts ??= new();
            ...
            label10.Text = 0.ToStringFileSize();
            ...
            //await GitHub.FileSystem.DownloadDirectoryAsync(GitHubPath, $"{DestinationPath}\\{fileName}", cts, (long bytesReceived, long bytesToReceive) =>
            //{
            //    if (_isClosing || bytesToReceive <= 0)
            //        return;
            ...
            //    Close();
            //},
            //(Exception ex) => throw ex /*Forms.BugReport.ThrowError(ex)*/,
            //() =>
            //{
            //    Close();

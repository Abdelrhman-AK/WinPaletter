...
namespace WinPaletter.GitHub
{
    public static partial class FileSystem
    {
        ...
        public class Entry
        {
            ...
            {
                GitHubCommit latestCommit = (await Program.GitHub.Client.Repository.Commit.GetAll(Repository.Owner, Repository.Name, new CommitRequest { Path = path })).FirstOrDefault();

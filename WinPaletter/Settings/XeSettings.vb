...
#End Region
    ...
    Sub CheckRegIfIntact()
        ...
        If Key.GetValue("Store_Online_Repositories", Nothing) Is Nothing Then Key.SetValue("Store_Online_Repositories", {My.Resources.Link_StoreMainDB, My.Resources.Link_StoreReposDB}, RegistryValueKind.MultiString)
    ...
    Sub New(ByVal LoadFrom As Mode, Optional ByVal File As String = Nothing)
        Select Case LoadFrom
            Case Mode.Registry
                ...
                Store_Online_Repositories = Key.GetValue("Store_Online_Repositories", {My.Resources.Link_StoreMainDB, My.Resources.Link_StoreReposDB})
            ...
            Case Mode.File
                ...
                For Each x As String In l
                    ...
                    If x.StartsWith("LoadThemeFileAsLegacy= ", My._ignore) Then AutoUpdatesChecking = x.Remove(0, "LoadThemeFileAsLegacy= ".Count)
                    If x.StartsWith("SaveThemeFileAsLegacy= ", My._ignore) Then AutoUpdatesChecking = x.Remove(0, "SaveThemeFileAsLegacy= ".Count)

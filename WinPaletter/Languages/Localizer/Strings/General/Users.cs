namespace WinPaletter
{
    public partial class Localizer
    {
        ...
        public string UserSwitch_LoginAs { get; set; } = "Login as {0}";
        public string UserSwitch_SYSTEM_Alert0 { get; set; } = "You should know that system accounts are generally reserved for very specific system-level tasks and should be approached with extreme caution. Incorrect use of SYSTEM-level access can lead to system instability. Always follow best practices for security and this is to avoid system corruption.";
        public string UserSwitch_SYSTEM_Alert1 { get; set; } = "Do you want to continue with this user? Pressing 'No' will continue with administrator user that opened WinPaletter.";
        public string UserSwitch_ERROR_UNKNOWN { get; set; } = "WinPaletter failed to login into selected user due to unknown reason. Try continuing without password.";
        ...
        public string UserSwitch_ERROR_LOGON_ACCESS_DENIED { get; set; } = "Access denied to system account. Try continuing without password.";
        public string UserSwitch_ERROR_INVALID_PARAMETER { get; set; } = "Invalid or incorrect username, or domain name or an incorrect logon type or logon provider specified, or problems with the password or other credentials, or incorrect values for any of the parameters passed to the function.";
        public string UserSwitch_ERROR_NO_TOKEN { get; set; } = "Can't get token to call functions on system account. Try to continuing without password.";

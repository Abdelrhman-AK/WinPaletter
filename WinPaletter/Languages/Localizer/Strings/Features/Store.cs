namespace WinPaletter
{
    public partial class Localizer
    {
        ...
        public string Store_PingFailed { get; set; } = "Couldn't get a response from '{0}'. Skipping this themes database.";
        ...
        public string Store_AuthorURLRedirect { get; set; } = "This will redirect you to the author's social media URL. Do you want to continue?";

...
namespace WinPaletter
{
    ...
    public class Localizer : IDisposable
    {
        ...
        public string CP_11_StartMenu_Taskbar_AC { get; set; } = "Start menu, taskbar && action center";
        public string CP_11_ACHover_Links { get; set; } = "Action center hover && links";
        public string CP_11_Taskbar_ACHover_Links { get; set; } = "Taskbar color, action center hover && links";
        public string CP_EP_ACButton_TaskbarAppLine { get; set; } = "Action center buttons && taskbar app underline";
        public string CP_11_Lines_Toggles_Buttons { get; set; } = "Lines, toggles, buttons, taskbar app underline && volume slider";
        public string CP_11_Lines_Toggles_Buttons_Overflow { get; set; } = "Lines, toggles, buttons, volume slider && taskbar tray (overflow)";
        public string CP_11_OverflowTray { get; set; } = "Taskbar tray overflow (requires 22H2, accent on taskbar enabled)";
        public string CP_11_StartMenu_AC { get; set; } = "Start menu && action center colors";
        public string CP_11_UnreadBadge { get; set; } = "Unread notifications count badge and other circles";
        public string CP_11_Settings { get; set; } = "Settings icons, text selection, focus dots && some pressed buttons";
        public string CP_11_SettingsAndTaskbarAppUnderline { get; set; } = "Settings icons, taskbar app underline, some pressed buttons && others";
        public string CP_11_SomePressedButtons { get; set; } = "Some pressed buttons";
        public string CP_UWPBackground { get; set; } = "UWP dialogs background (Windows 8.1 remnants in {0})";
        public string CP_10_ACLinks { get; set; } = "Action center links";
        public string CP_10_ACLinks_StartContextMenu { get; set; } = "Action center links and start's context menus";
        public string CP_10_TaskbarAppUnderline { get; set; } = "Taskbar app underline";
        public string CP_10_StartMenuIconHover { get; set; } = "Start menu icon hover";
        public string CP_10_Settings_Links_SomeBtns { get; set; } = "Settings icons, links && some pressed buttons";
        public string CP_10_Settings_Links_Taskbar_SomeBtns { get; set; } = "Settings icons, links, taskbar focused app && some pressed buttons";
        public string CP_10_Settings_Links_TaskbarUndeline_SomeBtns { get; set; } = "Settings icons, links, taskbar app underline && some pressed buttons";
        public string CP_10_Hamburger { get; set; } = "Sliding hamburger menu";
        public string CP_10_StartMenu_AC { get; set; } = "Start menu && action center";
        public string CP_EP_StartMenu_OverflowMenus { get; set; } = "Start menu && overflow menus";
        public string CP_EP_StartMenu_ActionCenterButtons { get; set; } = "Start menu && action center buttons";
        public string CP_EP_ActionCenterBackground { get; set; } = "Action center background";
        public string CP_10_StartMenu_AC_TaskbarActiveApp { get; set; } = "Start menu, action center && taskbar active app";
        public string CP_10_Taskbar { get; set; } = "Taskbar";
        public string CP_10_Taskbar_StartContextMenu { get; set; } = "Taskbar and start's context menus";
        public string CP_10_StartContextMenu { get; set; } = "Start's context menus";
        public string CP_EP_Taskbar_AppUnderline { get; set; } = "Taskbar && app underline";
        public string CP_10_Taskbar_ACLinks_StartContextMenu { get; set; } = "Taskbar background color, action center links && start's context menus";
        public string CP_10_TaskbarFocusedApp_StartButtonHover { get; set; } = "Taskbar focused app && Start menu button hover";
        public string CP_Undefined { get; set; } = "Undefined";
        public string CP_AccentOnTaskbarTib { get; set; } = "Applying accent on taskbar only isn't effective only for Windows 10 2015 versions, but it is effective for higher versions.";
        public string CP_Time { get; set; } = "It took {0} seconds";
        public string CP_Time_They { get; set; } = "They took {0} seconds";
        public string CP_Time_Cursors { get; set; } = "Total applying Windows cursors took {0} seconds";
        public string CP_ApplyFrom { get; set; } = "WinPaletter will apply theme from {0}'s section";
        public string CP_Admin_Msg0 { get; set; } = "Writing to registry without administrator rights by deflection";
        public string CP_Admin_Msg1 { get; set; } = "This deflection will take time more than if started as administrator";
        public string CP_Applying_Started { get; set; } = "Applying started";
        public string CP_SavingInfo { get; set; } = "Saving theme info into registry";
        public string CP_ThemeReset { get; set; } = "Resetting theme to default Windows to apply new theme correctly";
        public string CP_Applying_Win11 { get; set; } = "Applying Windows 11 scheme";
        public string CP_Applying_Win10 { get; set; } = "Applying Windows 10 scheme";
        public string CP_Applying_Win81 { get; set; } = "Applying Windows 8.1 scheme";
        public string CP_Applying_Win7 { get; set; } = "Applying Windows 7 theme";
        public string CP_Applying_WinVista { get; set; } = "Applying Windows Vista theme";
        public string CP_Applying_WinXP { get; set; } = "Applying Windows XP theme";
        public string CP_Applying_LogonUI11 { get; set; } = "Applying Windows 11 LogonUI";
        public string CP_Applying_LogonUI10 { get; set; } = "Applying Windows 10 LogonUI";
        public string CP_Applying_LogonUI8 { get; set; } = "Applying Windows 8.1 Lock Screen";
        public string CP_Applying_LogonUI7 { get; set; } = "Applying Windows 7 LogonUI";
        public string CP_Applying_LogonUIXP { get; set; } = "Applying Windows XP LogonUI";
        public string CP_Applying_Win32UI { get; set; } = "Applying Classic Colors";
        public string CP_Applying_WinEffects { get; set; } = "Applying Windows Effects";
        public string CP_Applying_WallpaperTone { get; set; } = "Applying Wallpaper Tone";
        public string CP_Applying_DesktopAllUsers { get; set; } = "Applying Wallpaper for all users";
        public string CP_Applying_CMD { get; set; } = "Applying Command Prompt";
        public string CP_Applying_Metrics { get; set; } = "Applying Windows Metrics and Fonts";
        public string CP_Applying_AltTab { get; set; } = "Applying Windows Switcher (Alt+Tab) appearance";
        public string CP_Applying_Wallpaper { get; set; } = "Applying Wallpaper";
        public string CP_Applying_AppTheme { get; set; } = "Applying WinPaletter application theme";
        public string CP_Applying_TerminalPreview { get; set; } = "Applying Windows Terminal Preview";
        public string CP_Applying_ScreenSaver { get; set; } = "Applying Screen Saver";
        public string CP_Applying_Sounds { get; set; } = "Applying Sounds";
        public string CP_Check_Terminals { get; set; } = "Checking if Windows Terminal (Stable & Preview) are installed";
        public string CP_Check_TerminalStable { get; set; } = "Checking if Windows Terminal Stable is installed";
        public string CP_Check_TerminalPreview { get; set; } = "Checking if Windows Terminal Preview is installed";
        public string CP_Skip_TerminalPreview { get; set; } = "Skipping Windows Terminal Preview as it is disabled";
        public string CP_Skip_TerminalStable { get; set; } = "Skipping Windows Terminal Stable as it is disabled";
        public string CP_Skip_Terminals { get; set; } = "Skipping Windows Terminal Stable & Preview as they are disabled";
        public string CP_Skip_Terminals_NotSupported { get; set; } = "Skipping Windows Terminal Stable, Preview. Not supported in this OS";
        public string CP_Skip_TerminalPreview_NotInstalled { get; set; } = "Skipping Windows Terminal Preview as it isn't installed";
        public string CP_Skip_TerminalPreview_DeflectionNotFound { get; set; } = "Skipping Windows Terminal Preview as deflected JSON doesn't exist";
        public string CP_Skip_TerminalStable_NotInstalled { get; set; } = "Skipping Windows Terminal Stable as it isn't installed";
        public string CP_Skip_TerminalStable_DeflectionNotFound { get; set; } = "Skipping Windows Stable Preview as deflected JSON doesn't exist";
        public string CP_Skip_CMD { get; set; } = "Skipping Command Prompt as it is disabled";
        public string CP_Applying_PS64 { get; set; } = "Applying PowerShell x64";
        public string CP_Skip_PS64 { get; set; } = "Skipping PowerShell x64 as it is disabled";
        public string CP_Applying_PS32 { get; set; } = "Applying PowerShell x86";
        public string CP_Skip_PS32 { get; set; } = "Skipping PowerShell x86 as it is disabled";
        public string CP_Skip_Metrics { get; set; } = "Skipping Windows Metrics and Fonts as they are disabled";
        public string CP_Skip_AltTab { get; set; } = "Skipping Windows Switcher (Alt+Tab) Appearance as it is disabled";
        public string CP_Skip_Wallpaper { get; set; } = "Skipping Wallpaper as it is disabled";
        public string CP_Skip_AppTheme { get; set; } = "Skipping WinPaletter application theme as it is disabled";
        public string CP_Skip_Sounds { get; set; } = "Skipping Sounds as its toggle is disabled";
        public string CP_CMD_Error { get; set; } = "Error occurred during applying Command Prompt";
        public string CP_PS32_Error { get; set; } = "Error occurred during applying PowerShell x86";
        public string CP_PS64_Error { get; set; } = "Error occurred during applying PowerShell x64";
        public string CP_WIN32UI_Error { get; set; } = "Error occurred during applying Classic Colors";
        public string CP_WinEffects_Error { get; set; } = "Error occurred during applying Windows Effects";
        public string CP_WallpaperTone_Error { get; set; } = "Error occurred during applying Wallpaper Tone";
        public string CP_LogonUI11_Error { get; set; } = "Error occurred during applying Windows 11 LogonUI";
        public string CP_LogonUI10_Error { get; set; } = "Error occurred during applying Windows 10 LogonUI";
        public string CP_LogonUI8_Error { get; set; } = "Error occurred during applying Windows 8.1 Lock Screen";
        public string CP_LogonUI7_Error { get; set; } = "Error occurred during applying Windows 7 LogonUI";
        public string CP_LogonUIXP_Error { get; set; } = "Error occurred during applying Windows XP LogonUI";
        public string CP_W10_Error { get; set; } = "Error occurred during applying Windows 10 scheme";
        public string CP_SavingInfo_Error { get; set; } = "Error occurred during saving theme info into registry";
        public string CP_ThemeReset_Error { get; set; } = "Error occurred during resetting theme to default Windows";
        public string CP_W11_Error { get; set; } = "Error occurred during applying Windows 11 scheme";
        public string CP_W7_Error { get; set; } = "Error occurred during applying Windows 7 theme";
        public string CP_WVista_Error { get; set; } = "Error occurred during applying Windows Vista theme";
        public string CP_W81_Error { get; set; } = "Error occurred during applying Windows 8.1 scheme";
        public string CP_WXP_Error { get; set; } = "Error occurred during applying Windows XP theme";
        public string CP_Error_Cursors { get; set; } = "Error occurred during applying Windows Cursors";
        public string CP_Error_SetDesktop { get; set; } = "Error occurred during applying Desktop for all users";
        public string CP_Error_Metrics { get; set; } = "Error occurred during applying Windows Metrics and Fonts";
        public string CP_Error_AltTab { get; set; } = "Error occurred during applying Windows Switcher (Alt+Tab) appearance";
        public string CP_Error_Wallpaper { get; set; } = "Error occurred during applying Wallpaper";
        public string CP_Error_AppTheme { get; set; } = "Error occurred during applying WinPaletter application theme";
        public string CP_Error_TerminalPreview { get; set; } = "Error occurred during applying Windows Terminal Preview";
        public string CP_Error_TerminalStable { get; set; } = "Error occurred during applying Windows Terminal Stable";
        public string CP_Error_ScreenSaver { get; set; } = "Error occurred during applying Screen Saver";
        public string CP_Error_Sounds { get; set; } = "Error occurred during applying Sounds";
        public string CP_MetricsHighDPIAlert { get; set; } = "Please Logoff and Logon after setting Metrics and Fonts with a high DPI";
        public string CP_Restricted_Cursors { get; set; } = "Modifying Windows Cursors is restricted from settings";
        public string CP_Applying_TerminalStable { get; set; } = "Applying Windows Terminal Stable";
        public string CP_AppliedWithErrors { get; set; } = "Applying theme done but with error/s. It took {0} seconds";
        public string CP_Applied { get; set; } = "Applying theme done. It took {0} seconds";
        public string CP_AllDone { get; set; } = "All operations are done";
        public string CP_ErrorHappened { get; set; } = @"Error\s happened. Press on 'Show Errors' for details";
        public string CP_LogWillClose { get; set; } = @"This log will close after {0} second\s";
        public string CP_RestoreCursorsError { get; set; } = "Error occurred during resetting cursors to aero. Anyway, process will continue.";
        public string CP_RestoreCursorsErrorPressOK { get; set; } = "Pressing OK will show details of exception error.";
        public string CP_RestoreCursorsTip { get; set; } = "If you want to restore default cursors, go to Control Panel > Mouse > Pointers";
        public string CP_UpdateDLL_AsAdmin_Error0 { get; set; } = "You must be running WinPaletter as Administrator to update resources of '{0}'";
        public string CP_UpdateDLL_AsAdmin_Error1 { get; set; } = "This process is required for changing Windows startup sound";
        public string CP_Wallpaper_NonBMP0 { get; set; } = "Due to odd reason, Windows XP, Vista & 7 can't set an image that is not a bitmap format directly as a wallpaper.";
        public string CP_Wallpaper_NonBMP1 { get; set; } = "Do you want to convert the current image to have internal bitmap format? (It will still have the same file extension)";
        ...
        public string CP_RenderingCustomLogonUI_MayNotRespond { get; set; } = "WinPaletter may not respond while rendering custom LogonUI";
        public string CP_RenderingCustomLogonUI_Progress { get; set; } = "Rendering custom LogonUI:";
        public string CP_RenderingCustomLogonUI { get; set; } = "Rendering custom LogonUI";
        public string CP_SavingCursorsColors { get; set; } = "Saving Windows Cursors Colors to registry";
        public string CP_RenderingCursors { get; set; } = "Rendering Windows Cursors";
        public string CP_RenderingCursors_Error { get; set; } = "Error occurred during rendering Windows Cursors";
        public string CP_CursorsApplying_Error { get; set; } = "Error occurred during applying Windows Cursors";
        public string CP_ApplyingCursors { get; set; } = "Applying Windows Cursors";

...
#Region "Deep-In-Code Strings"
    ...
    Property Verbose_RegScheme As String = "{0} > {1} = {2}, RegistryValueKind = {3}"
    Property Verbose_RegSkipped As String = "Skipped: {0}"
    Property Verbose_CreateTask As String = "Creating task {0} in Task Scheduler"
    Property Verbose_DeleteTask As String = "Deleting task {0} from Task Scheduler"
    Property Verbose_PE_GettingAccess As String = "Trying to get authorized access to change '{0}' access/permissions"
    Property Verbose_PE_GetAccessToChangeResources As String = "Trying to get authorized access to change '{0}' resources"
    Property Verbose_PE_CreateBackup As String = "Creating '{0}' backup"
    Property Verbose_PE_GetBackupPermissions As String = "Trying to get '{0}' permissions backup"
    Property Verbose_PE_PatchingPE As String = "Patching '{0}' resources"
    Property Verbose_PE_RestoringPermissions As String = "Restoring '{0}' permissions from backup"
    Property Verbose_SettingAero As String = "Setting 'Aero' visual styles using UxTheme.dll native method"
    Property Verbose_SettingAeroLite As String = "Setting 'Aero lite' visual styles using UxTheme.dll native method"
    Property Verbose_SettingAeroOpaque As String = "Setting 'Aero opaque' visual styles using UxTheme.dll native method"
    Property Verbose_SettingBasic As String = "Setting 'Basic' visual styles using UxTheme.dll native method"
    Property Verbose_SettingClassic As String = "Setting classic theme using UxTheme.dll native method"
    Property Verbose_SettingLunaBlue As String = "Setting 'Luna blue' visual styles using UxTheme.dll native method"
    Property Verbose_SettingLunaGreen As String = "Setting 'Luna green' visual styles using UxTheme.dll native method"
    Property Verbose_SettingLunaSilver As String = "Setting 'Luna sliver' visual styles using UxTheme.dll native method"
    Property Verbose_SettingVS As String = "Setting '{0}' visual styles using UxTheme.dll native method"
    Property Verbose_DeletingHighContrastThemes As String = "Deleting high contrast themes in '{0}'"
    Property Verbose_SettingWallpaper As String = "Setting desktop wallpaper using User32.dll native method"
    Property Verbose_SettingSlideshow As String = "Setting desktop slideshow data by modifying '{0}'"
    Property Verbose_SettingHSLImage As String = "Modifying HSL filters of selected image '{0}'"
    Property Verbose_SettingMetricsFonts As String = "Setting metrics and fonts using User32.dll native method"
    Property Verbose_SettingIconsMetrics As String = "Setting icons metrics using User32.dll native method"
    Property Verbose_SettingFontSmoothing As String = "Setting font smoothing option using User32.dll native method with value ({0})"
    ...
    Property Verbose_SettingMenuDelay As String = "Setting menu show delay using User32.dll native method with value ({0})"
    Property Verbose_SettingMenuSelectionFade As String = "Setting menu selection fade using User32.dll native method with value ({0})"
    Property Verbose_SettingComboBoxAnimation As String = "Setting combo box animation using User32.dll native method with value ({0})"
    Property Verbose_SettingListBoxSmoothScrolling As String = "Setting list box smooth scrolling using User32.dll native method with value ({0})"
    Property Verbose_SettingTooltipAnimation As String = "Setting tool tip animation using User32.dll native method with value ({0})"
    Property Verbose_SettingTooltipFade As String = "Setting tool tip fade using User32.dll native method with value ({0})"
    Property Verbose_SettingMenuUnderline As String = "Setting menu item underline on pressing ALT using User32.dll native method with value ({0})"
    Property Verbose_SettingFocusRectW As String = "Setting focus rectangle width using User32.dll native method with value ({0})"
    Property Verbose_SettingFocusRectH As String = "Setting focus rectangle height using User32.dll native method with value ({0})"
    Property Verbose_SettingCaretRect As String = "Setting text box caret width using User32.dll native method with value ({0})"
    Property Verbose_SettingAWT As String = "Setting active window tracking using User32.dll native method with value ({0})"
    Property Verbose_SettingAWT_ActivatedWindowTop As String = "Setting active window tracking (bring activated window to top) using User32.dll native method with value ({0})"
    Property Verbose_SettingAWT_Delay As String = "Setting active window tracking (delay) using User32.dll native method with value ({0})"
    Property Verbose_SettingSnapCursorToDefault As String = "Setting snap cursor to default button using User32.dll native method with value ({0})"
    Property Verbose_EnableExplorerBar As String = "Enabling explorer bar by renaming UIRibbon.dll into UIRibbon.dll_bak"
    Property Verbose_RestoreExplorerBar As String = "Restoring explorer ribbon/bar by renaming UIRibbon.dll_bak into UIRibbon.dll"
    Property Verbose_RegDelete As String = "Deleting: {0}"
    Property Verbose_BroadcastEffects As String = "Broadcasting all effects made to registry to force applying effects, using User32.dll native method"
    Property Verbose_GetInstanceLogonUIImg As String = "Getting an instance of LogonUI image into memory"
    Property Verbose_GetInstanceLockScreenImg As String = "Getting an instance of lock screen image into memory"
    Property Verbose_GrayscaleLogonUIImg As String = "Doing grayscale effect on LogonUI image"
    Property Verbose_GrayscaleLockScreenImg As String = "Doing grayscale effect on lock screen image"
    Property Verbose_BlurringLogonUIImg As String = "Blurring LogonUI image"
    Property Verbose_BlurringLockScreenImg As String = "Blurring lock screen image"
    Property Verbose_NoiseLogonUIImg As String = "Doing noise effect on LogonUI image"
    Property Verbose_NoiseLockScreenImg As String = "Doing noise effect on lock screen image"
    Property Verbose_LogonUIImgSaved As String = "Modified LogonUI image is saved into '{0}'"
    Property Verbose_LogonUIImgNUMSaved As String = "Modified LogonUI image number {1} is saved into '{0}'"
    Property Verbose_LockScreenImgSaved As String = "Modified lock screen image is saved into '{0}'"
    Property Verbose_SettingCursorShadow As String = "Setting cursor shadow using User32.dll native method with value ({0})"
    Property Verbose_SettingCursorSonar As String = "Setting cursor sonar using User32.dll native method with value ({0})"
    Property Verbose_SettingCursorTrails As String = "Setting cursor trails using User32.dll native method with value ({0})"
    Property Verbose_RenderingCursor As String = "Rendering cursor: {0}"
    Property Verbose_CursorRenderedInto As String = "Cursor is rendered into '{0}"
    Property Verbose_SettingCursor As String = "Setting system cursor {0} from file '{1}' using User32.dll native method"
    Property Verbose_RefreshingCursors As String = "Refreshing system cursors to show their effects using User32.dll native method"
    Property Verbose_DelCursorWPFromReg As String = "Deleting registry value 'WinPaletter' from '{0}' to start cursors restoration"
    ...
    Property PE_Systemfile As String = "System PE file"
    Property PE_ReplacedResourceProperties As String = "Replaced resource properties"
    Property PE_ResourceType As String = "Type"
    Property PE_ResourceID As String = "ID"
    Property PE_ResourceLanguageCode As String = "Language code"

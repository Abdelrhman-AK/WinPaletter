...
#Region "Deep-In-Code Strings"
    ...
    Property AppPreview As String = "App preview"
    Property InactiveApp As String = "Inactive app"
    ...
    Property Verbose_RegAdd As String = "{0} > {1} = {2}, RegistryValueKind = {3}"
    ...
    Property Verbose_UxTheme_SSVS As String = "Setting visual styles: {0}.{1}({2}, {3}, {4}, {5})"
    Property Verbose_UxTheme_ET As String = "Enabling theming: {0}.{1}({2})"
    Property Verbose_User32_SPI As String = "Calling {0}.{1}({2}, {3}, {4}, {5})"
    Property Verbose_User32_SSC As String = "Calling {0}.{1}({2}, {3})"
    Property Verbose_User32_SMT As String = "Broadcasting all effects made to registry: {0}.{1}({2}, {3}, {4}, {5}, {6}, {7}, {8})"
    ...
    Property Terminal_ConsoleSample As String = "Console sample"
    Property Terminal_ThisIsASelection As String = "This is a selection"
    Property Terminal_Another As String = "Another Terminal"
    ...
    Property Empty As String = "Empty"

...
namespace WinPaletter.Theme.Structures
{
    ...
    public class Sounds : ICloneable, IDisposable
    {
        ...
        {
            if (Program.Settings.AppLog.Enabled) Program.Log?.Write(LogEventLevel.Information, $"Loading Windows sounds settings from registry.");

            Enabled = Convert.ToBoolean(ReadReg(@"HKEY_CURRENT_USER\Software\WinPaletter\Sounds", string.Empty, @default.Enabled));
            Snd_Imageres_SystemStart = ReadReg(@"HKEY_CURRENT_USER\Software\WinPaletter\Sounds", "Imageres.dll_Startup", @default.Snd_Imageres_SystemStart).ToString();
            Snd_ChargerConnected = ReadReg(@"HKEY_CURRENT_USER\Software\WinPaletter\Sounds", "Snd_ChargerConnected", @default.Snd_ChargerConnected).ToString();
            Snd_ChargerDisconnected = ReadReg(@"HKEY_CURRENT_USER\Software\WinPaletter\Sounds", "Snd_ChargerDisconnected", @default.Snd_ChargerDisconnected).ToString();
            Snd_Win_WindowsLock = ReadReg(@"HKEY_CURRENT_USER\Software\WinPaletter\Sounds", "Snd_Win_WindowsLock", @default.Snd_Win_WindowsLock).ToString();
            Snd_WiFiConnected = ReadReg(@"HKEY_CURRENT_USER\Software\WinPaletter\Sounds", "Snd_WiFiConnected", @default.Snd_WiFiConnected).ToString();
            Snd_WiFiDisconnected = ReadReg(@"HKEY_CURRENT_USER\Software\WinPaletter\Sounds", "Snd_WiFiDisconnected", @default.Snd_WiFiDisconnected).ToString();
            Snd_WiFiConnectionFailed = ReadReg(@"HKEY_CURRENT_USER\Software\WinPaletter\Sounds", "Snd_WiFiConnectionFailed", @default.Snd_WiFiConnectionFailed).ToString();

            string Scope_Win = @"HKEY_CURRENT_USER\AppEvents\Schemes\Apps\.Default\{0}\.Current";
            Snd_Win_Default = ReadReg(string.Format(Scope_Win, ".Default"), string.Empty, @default.Snd_Win_Default).ToString();
            Snd_Win_AppGPFault = ReadReg(string.Format(Scope_Win, "AppGPFault"), string.Empty, @default.Snd_Win_AppGPFault).ToString();
            Snd_Win_CCSelect = ReadReg(string.Format(Scope_Win, "CCSelect"), string.Empty, @default.Snd_Win_CCSelect).ToString();
            Snd_Win_ChangeTheme = ReadReg(string.Format(Scope_Win, "ChangeTheme"), string.Empty, @default.Snd_Win_ChangeTheme).ToString();
            Snd_Win_Close = ReadReg(string.Format(Scope_Win, "Close"), string.Empty, @default.Snd_Win_Close).ToString();
            Snd_Win_CriticalBatteryAlarm = ReadReg(string.Format(Scope_Win, "CriticalBatteryAlarm"), string.Empty, @default.Snd_Win_CriticalBatteryAlarm).ToString();
            Snd_Win_DeviceConnect = ReadReg(string.Format(Scope_Win, "DeviceConnect"), string.Empty, @default.Snd_Win_DeviceConnect).ToString();
            Snd_Win_DeviceDisconnect = ReadReg(string.Format(Scope_Win, "DeviceDisconnect"), string.Empty, @default.Snd_Win_DeviceDisconnect).ToString();
            Snd_Win_DeviceFail = ReadReg(string.Format(Scope_Win, "DeviceFail"), string.Empty, @default.Snd_Win_DeviceFail).ToString();
            Snd_Win_FaxBeep = ReadReg(string.Format(Scope_Win, "FaxBeep"), string.Empty, @default.Snd_Win_FaxBeep).ToString();
            Snd_Win_LowBatteryAlarm = ReadReg(string.Format(Scope_Win, "LowBatteryAlarm"), string.Empty, @default.Snd_Win_LowBatteryAlarm).ToString();
            Snd_Win_MailBeep = ReadReg(string.Format(Scope_Win, "MailBeep"), string.Empty, @default.Snd_Win_MailBeep).ToString();
            Snd_Win_Maximize = ReadReg(string.Format(Scope_Win, "Maximize"), string.Empty, @default.Snd_Win_Maximize).ToString();
            Snd_Win_MenuCommand = ReadReg(string.Format(Scope_Win, "MenuCommand"), string.Empty, @default.Snd_Win_MenuCommand).ToString();
            Snd_Win_MenuPopup = ReadReg(string.Format(Scope_Win, "MenuPopup"), string.Empty, @default.Snd_Win_MenuPopup).ToString();
            Snd_Win_MessageNudge = ReadReg(string.Format(Scope_Win, "MessageNudge"), string.Empty, @default.Snd_Win_MessageNudge).ToString();
            Snd_Win_Minimize = ReadReg(string.Format(Scope_Win, "Minimize"), string.Empty, @default.Snd_Win_Minimize).ToString();
            Snd_Win_Notification_Default = ReadReg(string.Format(Scope_Win, "Notification.Default"), string.Empty, @default.Snd_Win_Notification_Default).ToString();
            Snd_Win_Notification_IM = ReadReg(string.Format(Scope_Win, "Notification.IM"), string.Empty, @default.Snd_Win_Notification_IM).ToString();
            Snd_Win_Notification_Looping_Alarm = ReadReg(string.Format(Scope_Win, "Notification.Looping.Alarm"), string.Empty, @default.Snd_Win_Notification_Looping_Alarm).ToString();
            Snd_Win_Notification_Looping_Alarm2 = ReadReg(string.Format(Scope_Win, "Notification.Looping.Alarm2"), string.Empty, @default.Snd_Win_Notification_Looping_Alarm2).ToString();
            Snd_Win_Notification_Looping_Alarm3 = ReadReg(string.Format(Scope_Win, "Notification.Looping.Alarm3"), string.Empty, @default.Snd_Win_Notification_Looping_Alarm3).ToString();
            Snd_Win_Notification_Looping_Alarm4 = ReadReg(string.Format(Scope_Win, "Notification.Looping.Alarm4"), string.Empty, @default.Snd_Win_Notification_Looping_Alarm4).ToString();
            Snd_Win_Notification_Looping_Alarm5 = ReadReg(string.Format(Scope_Win, "Notification.Looping.Alarm5"), string.Empty, @default.Snd_Win_Notification_Looping_Alarm5).ToString();
            Snd_Win_Notification_Looping_Alarm6 = ReadReg(string.Format(Scope_Win, "Notification.Looping.Alarm6"), string.Empty, @default.Snd_Win_Notification_Looping_Alarm6).ToString();
            Snd_Win_Notification_Looping_Alarm7 = ReadReg(string.Format(Scope_Win, "Notification.Looping.Alarm7"), string.Empty, @default.Snd_Win_Notification_Looping_Alarm7).ToString();
            Snd_Win_Notification_Looping_Alarm8 = ReadReg(string.Format(Scope_Win, "Notification.Looping.Alarm8"), string.Empty, @default.Snd_Win_Notification_Looping_Alarm8).ToString();
            Snd_Win_Notification_Looping_Alarm9 = ReadReg(string.Format(Scope_Win, "Notification.Looping.Alarm9"), string.Empty, @default.Snd_Win_Notification_Looping_Alarm9).ToString();
            Snd_Win_Notification_Looping_Alarm10 = ReadReg(string.Format(Scope_Win, "Notification.Looping.Alarm10"), string.Empty, @default.Snd_Win_Notification_Looping_Alarm10).ToString();
            Snd_Win_Notification_Looping_Call = ReadReg(string.Format(Scope_Win, "Notification.Looping.Call"), string.Empty, @default.Snd_Win_Notification_Looping_Call).ToString();
            Snd_Win_Notification_Looping_Call2 = ReadReg(string.Format(Scope_Win, "Notification.Looping.Call2"), string.Empty, @default.Snd_Win_Notification_Looping_Call2).ToString();
            Snd_Win_Notification_Looping_Call3 = ReadReg(string.Format(Scope_Win, "Notification.Looping.Call3"), string.Empty, @default.Snd_Win_Notification_Looping_Call3).ToString();
            Snd_Win_Notification_Looping_Call4 = ReadReg(string.Format(Scope_Win, "Notification.Looping.Call4"), string.Empty, @default.Snd_Win_Notification_Looping_Call4).ToString();
            Snd_Win_Notification_Looping_Call5 = ReadReg(string.Format(Scope_Win, "Notification.Looping.Call5"), string.Empty, @default.Snd_Win_Notification_Looping_Call5).ToString();
            Snd_Win_Notification_Looping_Call6 = ReadReg(string.Format(Scope_Win, "Notification.Looping.Call6"), string.Empty, @default.Snd_Win_Notification_Looping_Call6).ToString();
            Snd_Win_Notification_Looping_Call7 = ReadReg(string.Format(Scope_Win, "Notification.Looping.Call7"), string.Empty, @default.Snd_Win_Notification_Looping_Call7).ToString();
            Snd_Win_Notification_Looping_Call8 = ReadReg(string.Format(Scope_Win, "Notification.Looping.Call8"), string.Empty, @default.Snd_Win_Notification_Looping_Call8).ToString();
            Snd_Win_Notification_Looping_Call9 = ReadReg(string.Format(Scope_Win, "Notification.Looping.Call9"), string.Empty, @default.Snd_Win_Notification_Looping_Call9).ToString();
            Snd_Win_Notification_Looping_Call10 = ReadReg(string.Format(Scope_Win, "Notification.Looping.Call10"), string.Empty, @default.Snd_Win_Notification_Looping_Call10).ToString();
            Snd_Win_Notification_Mail = ReadReg(string.Format(Scope_Win, "Notification.Mail"), string.Empty, @default.Snd_Win_Notification_Mail).ToString();
            Snd_Win_Notification_Proximity = ReadReg(string.Format(Scope_Win, "Notification.Proximity"), string.Empty, @default.Snd_Win_Notification_Proximity).ToString();
            Snd_Win_Notification_Reminder = ReadReg(string.Format(Scope_Win, "Notification.Reminder"), string.Empty, @default.Snd_Win_Notification_Reminder).ToString();
            Snd_Win_Notification_SMS = ReadReg(string.Format(Scope_Win, "Notification.SMS"), string.Empty, @default.Snd_Win_Notification_SMS).ToString();
            Snd_Win_Open = ReadReg(string.Format(Scope_Win, "Open"), string.Empty, @default.Snd_Win_Open).ToString();
            Snd_Win_PrintComplete = ReadReg(string.Format(Scope_Win, "PrintComplete"), string.Empty, @default.Snd_Win_PrintComplete).ToString();
            Snd_Win_ProximityConnection = ReadReg(string.Format(Scope_Win, "ProximityConnection"), string.Empty, @default.Snd_Win_ProximityConnection).ToString();
            Snd_Win_RestoreDown = ReadReg(string.Format(Scope_Win, "RestoreDown"), string.Empty, @default.Snd_Win_RestoreDown).ToString();
            Snd_Win_RestoreUp = ReadReg(string.Format(Scope_Win, "RestoreUp"), string.Empty, @default.Snd_Win_RestoreUp).ToString();
            Snd_Win_ShowBand = ReadReg(string.Format(Scope_Win, "ShowBand"), string.Empty, @default.Snd_Win_ShowBand).ToString();
            Snd_Win_SystemAsterisk = ReadReg(string.Format(Scope_Win, "SystemAsterisk"), string.Empty, @default.Snd_Win_SystemAsterisk).ToString();
            Snd_Win_SystemExclamation = ReadReg(string.Format(Scope_Win, "SystemExclamation"), string.Empty, @default.Snd_Win_SystemExclamation).ToString();
            Snd_Win_SystemExit = ReadReg(string.Format(Scope_Win, "SystemExit"), string.Empty, @default.Snd_Win_SystemExit).ToString();
            Snd_Win_SystemStart = ReadReg(string.Format(Scope_Win, "SystemStart"), string.Empty, @default.Snd_Win_SystemStart).ToString();
            Snd_Win_SystemHand = ReadReg(string.Format(Scope_Win, "SystemHand"), string.Empty, @default.Snd_Win_SystemHand).ToString();
            Snd_Win_SystemNotification = ReadReg(string.Format(Scope_Win, "SystemNotification"), string.Empty, @default.Snd_Win_SystemNotification).ToString();
            Snd_Win_SystemQuestion = ReadReg(string.Format(Scope_Win, "SystemQuestion"), string.Empty, @default.Snd_Win_SystemQuestion).ToString();
            Snd_Win_WindowsLogoff = ReadReg(string.Format(Scope_Win, "WindowsLogoff"), string.Empty, @default.Snd_Win_WindowsLogoff).ToString();
            Snd_Win_WindowsLogon = ReadReg(string.Format(Scope_Win, "WindowsLogon"), string.Empty, @default.Snd_Win_WindowsLogon).ToString();
            Snd_Win_WindowsUAC = ReadReg(string.Format(Scope_Win, "WindowsUAC"), string.Empty, @default.Snd_Win_WindowsUAC).ToString();
            Snd_Win_WindowsUnlock = ReadReg(string.Format(Scope_Win, "WindowsUnlock"), string.Empty, @default.Snd_Win_WindowsUnlock).ToString();

            string Scope_Explorer = @"HKEY_CURRENT_USER\AppEvents\Schemes\Apps\Explorer\{0}\.Current";
            Snd_Explorer_ActivatingDocument = ReadReg(string.Format(Scope_Explorer, "ActivatingDocument"), string.Empty, @default.Snd_Explorer_ActivatingDocument).ToString();
            Snd_Explorer_BlockedPopup = ReadReg(string.Format(Scope_Explorer, "BlockedPopup"), string.Empty, @default.Snd_Explorer_BlockedPopup).ToString();
            Snd_Explorer_EmptyRecycleBin = ReadReg(string.Format(Scope_Explorer, "EmptyRecycleBin"), string.Empty, @default.Snd_Explorer_EmptyRecycleBin).ToString();
            Snd_Explorer_FeedDiscovered = ReadReg(string.Format(Scope_Explorer, "FeedDiscovered"), string.Empty, @default.Snd_Explorer_FeedDiscovered).ToString();
            Snd_Explorer_MoveMenuItem = ReadReg(string.Format(Scope_Explorer, "MoveMenuItem"), string.Empty, @default.Snd_Explorer_MoveMenuItem).ToString();
            Snd_Explorer_Navigating = ReadReg(string.Format(Scope_Explorer, "Navigating"), string.Empty, @default.Snd_Explorer_Navigating).ToString();
            Snd_Explorer_SecurityBand = ReadReg(string.Format(Scope_Explorer, "SecurityBand"), string.Empty, @default.Snd_Explorer_SecurityBand).ToString();
            Snd_Explorer_SearchProviderDiscovered = ReadReg(string.Format(Scope_Explorer, "SearchProviderDiscovered"), string.Empty, @default.Snd_Explorer_SearchProviderDiscovered).ToString();
            Snd_Explorer_FaxError = ReadReg(string.Format(Scope_Explorer, "FaxError"), string.Empty, @default.Snd_Explorer_FaxError).ToString();
            Snd_Explorer_FaxLineRings = ReadReg(string.Format(Scope_Explorer, "FaxLineRings"), string.Empty, @default.Snd_Explorer_FaxLineRings).ToString();
            Snd_Explorer_FaxNew = ReadReg(string.Format(Scope_Explorer, "FaxNew"), string.Empty, @default.Snd_Explorer_FaxNew).ToString();
            Snd_Explorer_FaxSent = ReadReg(string.Format(Scope_Explorer, "FaxSent"), string.Empty, @default.Snd_Explorer_FaxSent).ToString();

            string Scope_NetMeeting = @"HKEY_CURRENT_USER\AppEvents\Schemes\Apps\Conf\{0}\.Current";
            Snd_NetMeeting_PersonJoins = ReadReg(string.Format(Scope_NetMeeting, "Person Joins"), string.Empty, @default.Snd_NetMeeting_PersonJoins).ToString();
            Snd_NetMeeting_PersonLeaves = ReadReg(string.Format(Scope_NetMeeting, "Person Leaves"), string.Empty, @default.Snd_NetMeeting_PersonLeaves).ToString();
            Snd_NetMeeting_ReceiveCall = ReadReg(string.Format(Scope_NetMeeting, "Receive Call"), string.Empty, @default.Snd_NetMeeting_ReceiveCall).ToString();
            Snd_NetMeeting_ReceiveRequestToJoin = ReadReg(string.Format(Scope_NetMeeting, "Receive Request to Join"), string.Empty, @default.Snd_NetMeeting_ReceiveRequestToJoin).ToString();

            string Scope_SpeechRec = @"HKEY_CURRENT_USER\AppEvents\Schemes\Apps\sapisvr\{0}\.current";
            Snd_SpeechRec_DisNumbersSound = ReadReg(string.Format(Scope_SpeechRec, "DisNumbersSound"), string.Empty, @default.Snd_SpeechRec_DisNumbersSound).ToString();
            Snd_SpeechRec_HubOffSound = ReadReg(string.Format(Scope_SpeechRec, "HubOffSound"), string.Empty, @default.Snd_SpeechRec_HubOffSound).ToString();
            Snd_SpeechRec_HubOnSound = ReadReg(string.Format(Scope_SpeechRec, "HubOnSound"), string.Empty, @default.Snd_SpeechRec_HubOnSound).ToString();
            Snd_SpeechRec_HubSleepSound = ReadReg(string.Format(Scope_SpeechRec, "HubSleepSound"), string.Empty, @default.Snd_SpeechRec_HubSleepSound).ToString();
            Snd_SpeechRec_MisrecoSound = ReadReg(string.Format(Scope_SpeechRec, "MisrecoSound"), string.Empty, @default.Snd_SpeechRec_MisrecoSound).ToString();
            Snd_SpeechRec_PanelSound = ReadReg(string.Format(Scope_SpeechRec, "PanelSound"), string.Empty, @default.Snd_SpeechRec_PanelSound).ToString();
        }
        ...
        {
            if (Program.Settings.AppLog.Enabled) Program.Log?.Write(LogEventLevel.Information, $"Saving Windows sounds settings into registry.");

            SaveToggleState(treeView);

            // Save Windows sounds and unofficial sounds entries in WinPaletter's registry scope
            if (Program.Settings.AppLog.Enabled) Program.Log?.Write(LogEventLevel.Information, $"Saving unofficial Windows sounds entries in WinPaletter's registry scope.");
            ...
            if (Enabled)
            {
                ...
                {
                    if (Program.Settings.AppLog.Enabled) Program.Log?.Write(LogEventLevel.Information, $"Disabling Windows startup sound in registry.");
                ...
                {
                    if (Program.Settings.AppLog.Enabled) Program.Log?.Write(LogEventLevel.Information, $"Enabling Windows startup sound in registry.");
                ...
                {
                    if (Program.Settings.AppLog.Enabled) Program.Log?.Write(LogEventLevel.Information, $"{((!OS.W12 && !OS.W11) ? "Enabling" : "Disabling")} Windows startup sound in registry.");
                ...
                if (!OS.WXP)
                {
                    if (File.Exists(Snd_Imageres_SystemStart) && Path.GetExtension(Snd_Imageres_SystemStart).ToUpper() == ".WAV")
                    {
                        ...
                        {
                            if (Program.Settings.AppLog.Enabled) Program.Log?.Write(LogEventLevel.Information, $"Patching Windows startup sound in `imageres.dll`.");
                    ...
                    else if (Snd_Imageres_SystemStart.Trim().ToUpper() == "DEFAULT")
                    {
                        ...
                        {
                            if (Program.Settings.AppLog.Enabled) Program.Log?.Write(LogEventLevel.Information, $"Restoring default Windows startup sound by repatching `imageres.dll` with the default sound.");
                ...
                if (!Directory.Exists(SysPaths.SysEventsSoundsDir))
                {
                    ...
                    if (Program.Settings.AppLog.Enabled) Program.Log?.Write(LogEventLevel.Information, $"Creating directory for Windows sounds INI files: {SysPaths.SysEventsSoundsDir}.");
                }

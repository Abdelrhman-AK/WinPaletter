...
namespace WinPaletter
{
    ...
    public class PreviewHelpers
    {
        ...
        /// <param name="W81_start">Windows 8.1 start button in Windows 8.1 editing form</param>
        /// <param name="PersonalColorsBackground">Personal color for background</param>
        public static void ApplyMetroStartToButton(int ID, Color PersonalColorsBackground, UI.WP.Button W81_start)
        {
            switch (ID)
            {
                case 1:
                ...
                case 19:
                    {
                        W81_start.Image = PersonalColorsBackground.ToBitmap(new Size(48, 48));
                        break;
                    }
                case 20:
                    {

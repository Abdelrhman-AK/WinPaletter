...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.wiki/Asset/Classic/classic_versions.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.wiki/Asset/Classic/classic_toolbar_0.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.wiki/Asset/Classic/classic_toolbar_1.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.wiki/Asset/Classic/classic_0.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.wiki/Asset/Classic/classic_1.png?raw=true)

- There are two previews for 3D Objects, making it easier to know the look of selected colors on your system

![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.wiki/Asset/Classic/classic_2.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.wiki/Asset/Classic/classic_3.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.wiki/Asset/Classic/classic_4.png?raw=true)

- Controlling `Selection rectangles and hyperlinks`, `Hilight` and `Menu hilight` will modify folders/files/... selection like this:

![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.wiki/Asset/Classic/classic_remnant.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.wiki/Asset/Classic/classic_5.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.wiki/Asset/Classic/classic_6.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.wiki/Asset/Classic/classic_UPM.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.wiki/Asset/Classic/classic_lowerbuttons.png?raw=true)

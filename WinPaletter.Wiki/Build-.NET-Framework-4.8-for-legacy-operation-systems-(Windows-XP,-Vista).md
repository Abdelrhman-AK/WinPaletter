...
5. Move the .Net Framework installer into the main extracted folder, it will be like that:
    ...
    ![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/Media/Wiki/dotNet/0.png?raw=true)
...
8. You will find the new file like that: 
    ...
    ![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/Media/Wiki/dotNet/1.png?raw=true)

...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_0.png?raw=true)

2. Select Windows Terminal edition you want to modify

- It can be Stable or Preview

![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_1.png?raw=true)

- If the selected Windows Terminal is not installed, you will face this error:

![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_2.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_3.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_Toolbar.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_4.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_5_0.png?raw=true)

2. `Optional` You can create a new profile from this button: 

![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_5_1.png?raw=true)

3. `Optional` You can clone the selected profile into a new profile from this button:

![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_5_3.png?raw=true)

4. `Optional` You can copycat into the selected profile from another profile this button:

![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_5_4.png?raw=true)

![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_5_4_1.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_5_2.png?raw=true)

2. You can change profile name, tab title, tab icon, tab color and acrylic effect on titlebar (for all profiles)

![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_6.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_7.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_8_0.png?raw=true)

- A color profile has items: background, foreground, text selection, cursor color and 16 colors tables

![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_8_1.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_9.png?raw=true)

## 3. Font

- You can modify terminal font (they are monospaced fonts), weight and size

![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_10_0.png?raw=true)

- You can force using other fonts by checking this, but the console will render these fonts wrongly

![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_10_1.png?raw=true)

## 4. Cursor

- You can change cursor type and size

![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_11_0.png?raw=true)

- These are the types of cursors

![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_11_1.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_12_0.png?raw=true)

- You can adjust opacity of background image:

![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_12_1.png?raw=true)

- You can make the window of Windows Terminal in acrylic, with a track bar to control its intensity:

![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_12_2.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_13.png?raw=true)
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/WinPaletter.Wiki/Asset/WinTerminal/WT_14.png?raw=true)

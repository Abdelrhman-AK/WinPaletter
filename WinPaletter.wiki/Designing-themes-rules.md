...
![Save theme files compressed](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/Media/Wiki/Settings/WPTHCompress.png?raw=true)
...
![Application Theme](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/Media/Wiki/Store/WPTheme.png?raw=true)

![Theme Editing](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/Media/Wiki/WPTheme/4_0.png?raw=true)
...
![Theme Resources Pack](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/Media/Wiki/ThemeInfo/i3.png?raw=true)
   ...
   - Example: The file names must match to load the resources pack correctly.
     ...
     | Screenshot                     | ![hidden ext](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/Media/Wiki/Store/extscheme0.png?raw=true) | ![visible ext](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/Media/Wiki/Store/extscheme1.png?raw=true) |

   - This is incorrect—this will **not** load the theme resources pack:

![Wrong File Name Example](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/Media/Wiki/Store/extscheme2.png?raw=true) 
...
![Credits and Licenses](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/Media/Wiki/ThemeInfo/i4.png?raw=true)
...
![Descriptive Colors](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/Media/Wiki/ThemeInfo/i5.png?raw=true)

   2. Choose a decoration pattern for your theme.

![Decoration Pattern](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/Media/Wiki/ThemeInfo/i6.png?raw=true)

   3. Select the operating systems that your theme is designed for.

![Operating Systems](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/Media/Wiki/ThemeInfo/i7.png?raw=true)

   4. Load the info into your current theme.

![Load into Theme](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/Media/Wiki/ThemeInfo/i8.png?raw=true)

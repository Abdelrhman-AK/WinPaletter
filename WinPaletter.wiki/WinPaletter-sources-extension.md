...
- You can extend the scope of WinPaletter sources or even [create your own themes hosting server](https://github.com/Abdelrhman-AK/WinPaletter/wiki/Create-an-online-WinPaletter-Store-source-(server%5CGitHub-repository)-for-hosting-WinPaletter-themes).

- Source extension is done by links you get from a friend, obtained it online, or even built it.

---

## 2. Examples of sources that you can add to your WinPaletter setup: 
...
## 3. Add online sources to my WinPaletter setup:
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/Media/Wiki/Settings/StoreSource0.png?raw=true)

---

## 4. Add offline sources to my WinPaletter setup:
...
![alt text](https://github.com/Abdelrhman-AK/WinPaletter/blob/master/Media/Wiki/Settings/StoreSource1.png?raw=true)

...
## 3. [How to test the source you have built, being dependent on its URL](https://github.com/Abdelrhman-AK/WinPaletter/wiki/WinPaletter-Sources-extension)
